<div class="header">
    ...
    <a href="">
    <img class="m-4" src="{{ asset('assets/ass/img/logo.jpg') }}" alt="">
    </a>
    <a href="" class="logo-small img-fluid">
        <img src="{{ asset('assets/ass/img/logo.jpg') }}" alt="">
    </a>
    ...
    <hr class="m-0">
    <a class="dropdown-item logout pb-0" href="{{url('admin/logout')}}"><img src="{{asset('')}}assets/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
    </div>
    </div>
    </li>
    </ul>
    ...
    <li class="submenu">
    <li class="submenu">
    <a href="javascript:void(0);"><img src="{{asset('')}}assets/img/icons/users1.svg" alt="img"><span> Admin</span> <span class="menu-arrow"></span></a>
            <ul>
            <li><a href="{{url('admin/admin/add')}}">New Admin </a></li>
